...
function RefundCard({ contribution }: { contribution: BackerContribution }) {
  ...
  return (
    <div className="bg-white p-8 md:p-10 min_-h-[240px] rounded-[2rem] border border-blue-200 shadow-[0_12px_28px_-6px_rgba(59,130,246,0.12)] flex flex-col md:flex-row items-center justify-between gap-6 relative overflow-hidden hover:-translate-y-1 transition-transform duration-300">
...
function ActiveContributionCard({ contribution }: { contribution: BackerContribution }) {
  const progress = Math.min_((contribution.totalRaised / contribution.goal) * 100, 100);

  return (
    <div className="bg-white p-8 md:p-10 min_-h-[240px] rounded-[2rem] border border-slate-200 shadow-[0_12px_28px_-6px_rgba(15,23,42,0.08)] flex flex-col md:flex-row items-center justify-between gap-6 relative overflow-hidden hover:-translate-y-1 transition-transform duration-300">
...
function SuccessfulContributionCard({ contribution }: { contribution: BackerContribution }) {
  return (
    <div className="bg-slate-50 p-8 md:p-10 min_-h-[240px] rounded-[2rem] border border-slate-200 shadow-[inset_0_4px_20px_rgba(0,0,0,0.02)] flex flex-col md:flex-row items-center justify-between gap-6 relative overflow-hidden transition-all duration-500">
