  ...
  return (
    <div className="sticky top-32 space-y-6">
        <div className="text-center">
            <p className="text-sm font-bold text-slate-400 uppercase_ tracking-widest mb-4">Live Preview</p>
        </div>
        ...
        <div className="bg-white/50 backdrop-blur border border-slate-200 p-4 rounded-xl text-sm space-y-2 max-w-[320px] mx-auto mt-4">
            ...
            <div className="flex items-center gap-2 text-slate-500">
                <span className="w-20 text-xs uppercase_ font-semibold">Creator:</span>
                <span className="text-slate-900">{formData.creatorName || "..."}</span>
            </div>
            <div className="flex items-center gap-2 text-slate-500">
                <span className="w-20 text-xs uppercase_ font-semibold">Stage:</span>
                <span className="text-slate-900">{formData.projectStage}</span>
            </div>
            <div className="flex items-center gap-2 text-slate-500">
                <span className="w-20 text-xs uppercase_ font-semibold">Asset:</span>
