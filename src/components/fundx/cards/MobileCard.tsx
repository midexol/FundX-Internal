...
export function MobileCard({ campaign, progress }: MobileCardProps) {
  return (
    <div className="w-full_ bg-white rounded-[2rem] shadow-soft-md border border-slate-100 overflow_-hidden flex flex-col">
      ...
      <div className="p-6 flex flex-col gap-4">
        ...
        <div className="w-full_ bg-slate-100 rounded-full_ h-2 overflow_-hidden">
          <div
