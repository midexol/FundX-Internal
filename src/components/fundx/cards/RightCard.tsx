        ...
        <div className="space-y-3 pt-4">
          ...
          <div className="flex justify-between items_-center">
            ...
            <Link href={`/campaigns/${campaign.id}`}>
              <Button
                size="sm"
                className="h-10 rounded-xl bg-slate-900 text-white shadow-md hover:bg-primary_ hover:shadow-glow transition-all px-5 flex items_-center gap-1.5 group/btn"
              >
                Donate
