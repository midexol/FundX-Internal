  ...
  return (
    <div className="w-full h-full bg-white rounded-[2rem] shadow-soft-md border border-slate-100 overflow-hidden group hover:border-orange-200 transition-all duration-500 ease-out flex flex-col hover:scale-[1.03]">
      <div className="relative h-48 xl:h-1/2 bg-slate-100 overflow-hidden shrink-0">
        <div className="absolute inset-0 flex items_-center justify_-center text-slate-300 text-sm font-bold bg-slate-50 group-hover:scale-105 transition-transform duration-700">
          [Image]
        </div>
      </div>
      ...
      <div className="p-6 flex flex-col justify_-between flex-1 bg-white">
        ...
        <div className="space-y-3 pt-4">
          ...
          <div className="flex justify_-between items_-center">
            <div>
