  ...
  return (
    <footer className="bg-white pt-20 pb-12 border-t border-slate-100">
      <div className="container mx-auto max-w-6xl px-4">
        ...
        <div className="flex flex-col_ lg:flex-row justify-between items-start gap-12 lg:gap-24">
          
          {/* LEFT SIDE: Brand, Nav, Socials (Matching 'Karma' Image) */}
          <div className="flex flex-col_ items-start space-y-8 w-full_ lg:w-auto">
          ...
          <div className="flex flex-col_ gap-2 w-full_ lg:w-auto lg:min-w-[400px]">
