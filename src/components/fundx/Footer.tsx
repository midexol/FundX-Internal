          ...
          <div className="flex flex-col items-start space-y-8 w-full lg:w-auto">
            ...
            <div className="flex items-center gap-5 text-slate-900">
              ...
              <a href="#" className="hover:text-primary transition-colors hover:scale-110">
                <svg role_="img" viewBox="0 0 24 24" fill="currentColor" className="w-5 h-5">
              ...
              {/* Discord */}
              <a href="#" className="hover:text-primary transition-colors hover:scale-110">
                 <svg role_="img" viewBox="0 0 24 24" fill="currentColor" className="w-6 h-6">
              ...
              {/* Docs/Mirror Icon */}
              <a href="#" className="hover:text-primary transition-colors hover:scale-110">
                <svg role_="img" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className="w-5 h-5">
