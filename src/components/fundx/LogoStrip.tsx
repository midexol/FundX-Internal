  ...
  return (
    <div className="w-full border-t border-slate-100 py-20"> {/* No background */}
      <div className="container mx-auto max-w-5xl px-4">
        ...
        <div className="flex flex-wrap justify_-center items-center gap-16 md:gap-32">
          ...
          <div className="flex items-center justify_-center h-12 w-40 cursor-default group">
