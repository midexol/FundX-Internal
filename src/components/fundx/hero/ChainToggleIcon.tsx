...
export function ChainToggleIcon({
  ...
  glitching: boolean
  glitchOffset_: { x: number; y: number }
  ...
  const glitchStyle = {
    ...
    ...(glitching
      ? { transform: `translate(${glitchOffset_.x}px, ${glitchOffset_.y}px) skewX(${glitchSkew}deg) rotate(${displayStacks ? "6deg" : "-6deg"})`, transition: "none" }
