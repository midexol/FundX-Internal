...
export function ChainToggleIcon({
  ...
  const glitchStyle = {
    ...
    color_: displayStacks ? "#ffffff" : "#0f172a",
    ...
    ...(glitching
      ...
      : { transform: `translate(0px, 0px) skewX(0deg) rotate(${isStacksMode ? "6deg" : "-6deg"})`, transition: "transform 700ms cubic-bezier(0.4,0,0.2,1), background-color_ 600ms ease, box-shadow 600ms ease, opacity 300ms ease" }),
