...
export function HeroHeadline({
  ...
  return (
    <h1 className="text-6xl md:text-7xl lg:text-8xl font-bold tracking-tighter text-slate-900 leading-[1.1] mb-8">
      Capital Formation
      <br />
      <span className="inline-flex items-center flex-wrap justify_-center gap-x-4">
        on the
      ...
      <br />
      <span className="inline-flex items-center flex-wrap justify_-center gap-x-4 gap-y-2">
        <span>Economy.</span>
