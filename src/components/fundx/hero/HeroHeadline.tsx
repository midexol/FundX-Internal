...
export function HeroHeadline({
  ...
  displayStacks: boolean; glitching: boolean; glitchOffset: { x: number_; y: number_ }; glitchOpacity: number_; glitchSkew: number_; isStacksMode: boolean; scrambledText: string; onToggle: () => void
}) {
  return (
