...
export function ChainToggleSwitch({ isStacksMode, onToggle_ }: { isStacksMode: boolean; onToggle_: () => void }) {
  return (
    <span className="inline-flex align-middle ml-2">
      <button onClick={onToggle_} aria-label="Toggle between Bitcoin and Stacks" className="relative inline-flex items-center cursor-pointer focus:outline-none" style={{ WebkitTapHighlightColor: "transparent" }}>
