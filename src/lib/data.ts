...
export const CAMPAIGNS: Campaign[] = [
  ...
  },
  {
    ...
    description:  "Developing urban infrastructure powered by Bitcoin mining heat recycling. A model for sustainable_ cities.",
  ...
  // --- FAILED CAMPAIGNS (Will sort to bottom) ---
  {
    ...
    description: "Carbon neutral production ensuring the future of sustainable_ POW.",
    category: "Mining",
    projectStage: "Idea",
    location: "Austin, TX",
    raised: 5000,
