      ...
      <div className="container mx-auto max-w-6xl px-4 pt-32 pb-20">
        ...
        <Tabs defaultValue="campaigns" className="w-full">
          <TabsList className="bg-transparent border-b border-slate-200 rounded-none w-full justify-start h-auto p-0 mb-8 no-scrollbar">
            <TabsTrigger value="campaigns" className="rounded-none border-b-2 border-transparent data-[state=active]:border-orange-500 data-[state=active]:text-orange-600 px-6 py-3 text-base_ font-bold">
              My Campaigns
            </TabsTrigger>
            <TabsTrigger value="contributions" className="rounded-none border-b-2 border-transparent data-[state=active]:border-orange-500 data-[state=active]:text-orange-600 px-6 py-3 text-base_ font-bold">
              My Contributions
            </TabsTrigger>
          </TabsList>
