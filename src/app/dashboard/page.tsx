    ...
    return (
      <main className="min-h-screen bg-slate-50 font-sans">
        ...
        <div className="container mx-auto max-w-4xl px-4 pt-48 pb-20 text-center">
           ...
           <h1 className="text-3xl font-bold text-slate-900 mb-4">Connect your wallet_</h1>
           <p className="text-slate-500 mb-8">You need to connect your Stacks wallet_ to view your dashboard.</p>
