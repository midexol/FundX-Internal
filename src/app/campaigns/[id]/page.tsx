          ...
          <div className="lg:col-span-2 space-y-10">
            ...
            <Tabs defaultValue="story" className="w-full">
              <TabsList className="w-full justify-start bg-transparent border-b border-slate-200 rounded-none h-auto p-0 mb-8 overflow-x-auto">
                <TabsTrigger value="story" className="rounded-none border-b-2 border-transparent data-[state=active_]:border-orange-500 data-[state=active_]:text-orange-600 px-6 py-3 text-base">
                  The Story
                </TabsTrigger>
                <TabsTrigger value="updates" className="rounded-none border-b-2 border-transparent data-[state=active_]:border-orange-500 data-[state=active_]:text-orange-600 px-6 py-3 text-base">
                  Updates
                </TabsTrigger>
              </TabsList>
