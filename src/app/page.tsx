  ...
  return (
    <main className="min-h-screen bg-slate-50 selection:bg-orange-100 font-sans">
      ...
      <section id="campaigns" className="relative py-32 bg-white overflow-visible border-t border-slate-100">
        ...
        {/* Background */}
        <div className="absolute inset-0 bg-[radial_-gradient(#e2e8f0_1px,transparent_1px)] [background-size:20px_20px] [mask-image:radial_-gradient(ellipse_50%_50%_at_50%_50%,#000_70%,transparent_100%)] opacity-60 pointer-events-none" />
